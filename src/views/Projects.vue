              ...
              <div class="-mx-4 flex flex-wrap items-center">
                  <div class="w-full px-4 md:w-8/12 lg:w-7/12">
                      <div class="mb-8 max-w-[570px] md:mb-0 lg:mb-12">
                          <h1 class="mb-5 text-2xl font-bold text-black dark:text-white sm:text-3xl">Проекты</h1>
                          <p class="text-base font-medium leading-relaxed text-body-color">Некоторые из моих проектов (коммерческий, а также учебный опыт)</p>
                      </div>
                  </div>
                  <div class="w-full px-4 md:w-4/12 lg:w-5/12">
                      <div class="text-end">
                          <ul class="flex items-center md:justify-end">
                              ...
                              <li class="text-base font-medium text-primary">Проекты</li>
                          </ul>
                      </div>
                  </div>
              </div>
