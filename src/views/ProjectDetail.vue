        ...
        <div class="container">
            <div class="-mx-4 flex flex-wrap justify-center">
                <div class="w-full px-4 lg:w-8/12">
                    <div>
                        <h2 class="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">{{ post.title.rendered }}</h2>
                        <div class="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                            <div class="flex flex-wrap items-center">
                                <div class="mb-5 mr-10 flex items-center">
                                    <div class="mr-4">
                                        <div class="relative h-10 w-10 overflow-hidden rounded-full">
                                            <img alt="author" loading="lazy" decoding="async" data-nimg="fill" sizes="100vw" src="/images/SM2.png" style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                                        </div>
                                    </div>
                                    <div class="w-full"><span class="mb-1 text-base font-medium text-body-color">Sergey Mikhailov</span></div>
                                </div>
                                <div class="mb-5 flex items-center">
                                    <p class="mr-5 flex items-center text-base font-medium text-body-color">
                                        <span class="mr-3">
                                    ...
                                    <!-- <p class="mr-5 flex items-center text-base font-medium text-body-color"><span class="mr-3">
                            ...
                            <!-- <div class="mb-5"><a href="#0" class="inline-flex items-center justify-center rounded-full bg-primary px-4 py-2 text-sm font-semibold text-white">Design</a></div> -->
                        </div>
                        <div>
                            ...
                            <div class="mb-10 w-full overflow-hidden rounded">
                                <div class="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                                    <Swiper
                                        ...
                                        autoplay
                                    >
                                        <SwiperSlide v-for="(item,i) in post.images" :key="i">
                            ...
                            <h3 class="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">Описание проекта</h3>

                            <p v-if="post" class="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">{{post.description}}</p>

                            <!-- <p class="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">Semper auctor neque vitae tempus quam pellentesque nec.<span class="text-primary underline dark:text-white">Amet dictum sit amet justo</span>donec enim diam. Varius sit amet mattis vulputate enim nulla aliquet porttitor. Odio pellentesque diam volutpat commodo sed.</p> -->

                            <h3 class="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">Данные проекта</h3>

                            <!-- <p class="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">consectetur adipiscing elit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat mattis vulputate cupidatat.</p> -->

                            <ul class="mb-10 list-inside list-disc text-body-color">
                                <li v-if="post" class="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg"><strong>Заказчик</strong>: {{post.client}}</li>
                                <li v-if="post" class="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg"><strong>Должность</strong>: {{post.spec}}</li>
                                <li v-if="post" class="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg"><strong>Период</strong>: {{post.period}}</li>
                                <li v-if="post" class="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg"><strong>Сайт проекта</strong>: <a :href="`${post.siteurl}`" class="hover:text-primary" target="_blank">{{post.siteurl}}</a></li>
                            </ul>

                            <!-- <div class="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                                <p class="text-center text-base font-medium italic text-body-color">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod incididunt utionals labore et dolore magna aliqua. Quis lobortis scelerisque fermentum, The Neque ut etiam sit amet.</p><span class="absolute left-0 top-0 z-[-1]"><svg width="132" height="109" viewBox="0 0 132 109" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.5" d="M33.0354 90.11C19.9851 102.723 -3.75916 101.834 -14 99.8125V-15H132C131.456 -12.4396 127.759 -2.95278 117.318 14.5117C104.268 36.3422 78.7114 31.8952 63.2141 41.1934C47.7169 50.4916 49.3482 74.3435 33.0354 90.11Z" fill="url(#paint0_linear_111:606)"></path>
                                        <path opacity="0.5" d="M33.3654 85.0768C24.1476 98.7862 1.19876 106.079 -9.12343 108.011L-38.876 22.9988L100.816 -25.8905C100.959 -23.8126 99.8798 -15.5499 94.4164 0.87754C87.5871 21.4119 61.9822 26.677 49.5641 38.7512C37.146 50.8253 44.8877 67.9401 33.3654 85.0768Z" fill="url(#paint1_linear_111:606)"></path>
                                        <defs>
                                    ...
                                    </svg></span><span class="absolute bottom-0 right-0 z-[-1]"><svg width="53" height="30" viewBox="0 0 53 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle opacity="0.8" cx="37.5" cy="37.5" r="37.5" fill="#4A6CF7"></circle>
                                        <mask id="mask0_111:596" maskUnits="userSpaceOnUse" x="0" y="0" width="75" height="75" style="mask-type: alpha;">
                                            <circle opacity="0.8" cx="37.5" cy="37.5" r="37.5" fill="#4A6CF7"></circle>
                                        </mask>
                                        <g mask="url(#mask0_111:596)">
                                            <circle opacity="0.8" cx="37.5" cy="37.5" r="37.5" fill="url(#paint0_radial_111:596)"></circle>
                                            <g opacity="0.8" filter="url(#filter0_f_111:596)">
                                                <circle cx="40.8089" cy="19.853" r="15.4412" fill="white"></circle>
                                            </g>
                                        </g>
                                        <defs>
                                            <filter id="filter0_f_111:596" x="4.36768" y="-16.5881" width="72.8823" height="72.8823" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                                ...
                                                <feGaussianBlur stdDeviation="10.5" result="effect1_foregroundBlur_111:596"></feGaussianBlur>
                                            </filter>
                            ...
                            <div class="items-center justify-between sm:flex">
                                ...
                                <!-- <div class="mb-5">
                                    <h5 class="mb-3 text-sm font-medium text-body-color sm:text-right">Share this post :</h5>
                                    <div class="flex items-center sm:justify-end">
                                        <a href="#0" aria-label="social-share" class="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-sm bg-gray-light text-body-color duration-300 hover:bg-primary hover:text-white dark:bg-gray-dark dark:hover:bg-primary sm:ml-3">
                                        ...
                                        <a href="#0" aria-label="social-share" class="mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-sm bg-gray-light text-body-color duration-300 hover:bg-primary hover:text-white dark:bg-gray-dark dark:hover:bg-primary"><svg width="18" height="18" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a href="#0" aria-label="social-share" class="mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-sm bg-gray-light text-body-color duration-300 hover:bg-primary hover:text-white dark:bg-gray-dark dark:hover:bg-primary">
                                            <svg width="18" height="18" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12.1 10.4939V7.42705C12.1 6.23984 13.085 5.27741 14.3 5.27741H16.5V2.05296L13.5135 1.84452C10.9664 1.66676 8.8 3.63781 8.8 6.13287V10.4939H5.5V13.7183H8.8V20.1667H12.1V13.7183H15.4L16.5 10.4939H12.1Z" fill="currentColor"></path>
                                            </svg>
                                        </a>
                                    </div>
                                </div> -->
...
<script setup>
  ...
  onMounted(() => {
    ...
    store.fetchPosts().then(() => {
      const selectedPost = store.posts.find((p) => p.id === Number(postId));
      if (selectedPost) {
        store.selectPost(selectedPost);
      }
    });
